...
inline const char kIntentPrompt[] PROGMEM =
    ...
    "- \"personal_query\" - ask about OR act on the user's personal data: notes /\n"
    "                       wiki / 2nd brain, calendar / schedule / meetings,\n"
    "                       email / inbox / drafts, projects / next actions\n"
    "- \"journal_note\"   - save a voice note into the user's 2nd brain\n"
    "\n"
    "Examples:\n"
    ...
    "{\"intent\":\"personal_query\",\"entity\":null,\"query\":\"what's on my calendar today\"}\n"
    "\n"
    "User: any new email from doctor smith\n"
    "{\"intent\":\"personal_query\",\"entity\":null,\"query\":\"any new email from doctor smith\"}\n"
    "\n"
    "User: draft a reply to mom saying I'll be home for dinner\n"
    "{\"intent\":\"personal_query\",\"entity\":null,\"query\":\"draft a reply to mom saying I'll be home for dinner\"}\n"
    "\n"
    "User: what's next on the boat project\n"
    "{\"intent\":\"personal_query\",\"entity\":null,\"query\":\"what's next on the boat project\"}\n"
    "\n"
    "User: ";
